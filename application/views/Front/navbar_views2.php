...
<?php } else if( ($this->session->userdata('logged_in')) and (($perfil_id)=='3')){
  ?> 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <li id="dropdown" class="nav-item dropdown">
        <a class="nav-link dropdown-toggle hvr-underline-from-center" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>Bienvenido SuperAdmin <?= $nombre ?></b></a></a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: black;">
          <a class="dropdown-item" href="<?php echo base_url('mostrar_datos');?>">Mis datos</a>
          <a class="dropdown-item" href="<?php echo base_url('cerrar_sesion');?>">Salir</a>
      </li>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        ...
        <a class="nav-link hvr-underline-from-center" href="<?php echo base_url('consulta');?>">Consultar</a>
         ...
         <li class="nav-item">
        <a class="nav-link hvr-underline-from-center" href="<?php echo base_url('nuestros_productos');?>">Nuestros Productos</a>
      </li>
    <!--Formulario para buscar algo-->
    <!--
